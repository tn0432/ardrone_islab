#!/usr/bin/env python
import roslib; 
roslib.load_manifest('TrackingController')
import rospy
import math
import time
import numpy as np
...
from PIDcontrol import OutputControl
from GeometricControl import GeometricTrackingController
...
if __name__ == '__main__':
	...
	#YawGoalRotate = 0
        ...
        GoalTf.sendTransform((Xref, Yref, Zref),tf.transformations.quaternion_from_euler(0.0,0.0, YawGoalRotate),rospy.Time.now(),"/goal","/odom") 
